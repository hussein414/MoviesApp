...
import com.example.mvvmmoviesapp.ui.state.MovieListState
import com.example.mvvmmoviesapp.ui.view.component.MovieItem
        ...
        LazyVerticalGrid(
            ...
            items(movieListState.popularMovieList.size) { index ->
                ...
                if (index >= movieListState.popularMovieList.size - 1 && !movieListState.isLoading){
                    onEvent(MovieListUiEvent.Paginate(category = Constance.POPULAR))
                }
            }
        }
    }
